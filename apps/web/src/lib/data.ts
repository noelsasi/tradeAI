...
const items: TradeData['items'] = [
    ...
    alternatives: [
      {
        code: '8471.41.0000',
        reason:
          'Rejected — applies to non-portable ADP machines presented as a system; unit is a standalone portable.',
      },
      {
        code: '8471.49.0000',
        reason:
          'Rejected — covers systems presented as multiple separate units; this is a single integrated notebook.',
      },
    ],
  ...
  },
  {
    ...
    alternatives: [
      {
        code: '6205.20.0000',
        reason: 'Rejected — covers woven cotton shirts; goods are knitted, not woven.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
  {
    ...
    alternatives: [
      {
        code: '2523.21.0000',
        reason: 'Rejected — reserved for white Portland cement; product is grey OPC.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '8539.52.0000',
        reason:
          'Considered — if presented as bare LED light sources / modules rather than complete fixtures, 8539.52 would apply.',
      },
      {
        code: '9405.49.0000',
        reason: 'Considered — residual subheading; 9405.40 preferred for complete fittings n.e.s.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
  {
    ...
    alternatives: [
      {
        code: '1006.20.0000',
        reason: 'Rejected — applies to husked (brown) rice; product is milled white rice.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
  {
    ...
    alternatives: [
      {
        code: '8507.80.0000',
        reason: 'Rejected — residual for other accumulators; chemistry is explicitly lithium-ion.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
    ...
    alternatives: [
      {
        code: '7213.10.0000',
        reason:
          'Rejected — applies to bars/rods in irregularly wound coils; product is straight-length rebar.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '8524.91.0000',
        reason:
          'Considered — standalone flat-panel display modules are classified under 8524 by GIR; mixed consignment kept under parts heading pending line detail.',
      },
      {
        code: '8517.62.0000',
        reason: 'Rejected — covers complete reception/transmission apparatus, not parts.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
  {
    ...
    alternatives: [
      {
        code: '1509.30.0000',
        reason: 'Rejected — covers virgin (non-extra) olive oil; product is labelled extra virgin.',
      },
      {
        code: '1509.90.0000',
        reason: 'Rejected — residual for other olive oil; specific subheading available.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '8415.81.0000',
        reason:
          'Rejected — applies to other AC machines incorporating a refrigerating unit, used for larger systems, not wall split types.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '6907.22.0000',
        reason:
          'Rejected — applies to tiles with water absorption >0.5% but ≤10%; porcelain spec indicates ≤0.5%.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '8502.12.0000',
        reason:
          'Likely correct — 8502.12 covers compression-ignition generating sets of output >75 kVA but ≤375 kVA, matching the stated 100 kVA.',
      },
      {
        code: '8502.11.0000',
        reason: 'Rejected — for sets of output ≤75 kVA.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  ...
  },
  {
    ...
    alternatives: [
      {
        code: '8525.81.0000',
        reason: 'Considered — for high-speed cameras; not applicable.',
      },
      {
        code: '8517.62.0000',
        reason:
          'Considered — if the NVR is classified separately as reception/recording apparatus; split classification may apply.',
      },
    ],
  ...
  },
  {
    ...
    alternatives: [
      {
        code: '1103.11.0000',
        reason: 'Rejected — applies to groats and meal of wheat, a coarser product than flour.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
  {
    ...
    alternatives: [
      {
        code: '7324.90.0000',
        reason: 'Rejected — residual subheading; specific entry for stainless sinks available.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
  },
    ...
    alternatives: [
      {
        code: '3003.90.0000',
        reason:
          'Rejected — for medicaments not put up in measured doses or retail packings; product is blister/retail packed.',
      },
    ],
    sanctions: { ofac: 'Clear', un: 'Clear', eu: 'Clear' },
...
export const DEMO_DATA: TradeData = {
  items,
  summary: {
    total: items.length,
    ...
    sanctions: items.filter(
      (i) =>
        i.sanctions.ofac !== 'Clear' || i.sanctions.un !== 'Clear' || i.sanctions.eu !== 'Clear',
    ).length,
    processingTime: 11.8,
    complianceScore: 87,
  },
  processingSteps: [
    {
      key: 'extract',
      label: 'Extracting line items from documents',
      detail: '16 line items detected across 2 documents',
    },
    {
      key: 'classify',
      label: 'Classifying GCC HS codes',
      detail: 'Matching against 12-digit GCC tariff schedule',
    },
    {
      key: 'screen',
      label: 'Screening sanctions & watchlists',
      detail: 'OFAC · UN · EU consolidated lists',
    },
    {
      key: 'report',
      label: 'Generating compliance report',
      detail: 'Mirsal 2 format · risk scoring',
    },
  ],
  docMeta: {
    client: 'Shippify UAE',
